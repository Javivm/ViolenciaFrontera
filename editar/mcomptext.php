	...
	if(isset($_POST['Borra'])){ //CHECAR SI PICO BORRAR NOTICIA
		...
		// PARA ESTO SELECCIONAR LOS QUE NO HAYA MANDADO EL USUARIO CON != Y EN GURPO CON GROUP BY
			...
			echo '<form action="" method="post">
				  ...
				  <div><input type="text" name="Grupo" value="'.$Grupo.'"></div>
				  ...
				  <div><input type="text" name="Pais" value="'.$Pais.'"></div>
				  <div><input type="text" name="Estado" value="'.$Estado.'"></div>
				  <div><input type="text" name="Municipio" value="'.$Municipio.'"></div>
				  <div><input type="text" name="Categoria" value="'.$Categoria.'"></div>

...
function initialize() {
  ...
  var locacionEvento1 = new google.maps.LatLng(32.525000, -117.016700);
  ...
  locacionEvento2Marker.addListener('click', function() {
    infoEvento2.open(map, locacionEvento2Marker);
  });


	
  var locacionEvento3 = new google.maps.LatLng(31.761878, -106.485022);

  var locacionEvento3Marker = new google.maps.Marker({
      position: locacionEvento3,
      map: map,
      title:"Evento3",
      //icon: image
  });
  ...
  var contentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h1 id="firstHeading" class="firstHeading">Prueba3</h1>'+
      '<div id=bodyContent>'+
      '<p><b>Uluru</b>, also referred to as <b>Ayers Rock</b>, is a large ' +
      'sandstone rock formation in the southern part of the '+
      'Northern Territory, central Australia. It lies 335&#160;km (208&#160;mi) '+
  ...
  var infoEvento3 = new google.maps.InfoWindow({
    content: contentString
  });


  locacionEvento3Marker.addListener('click', function() {
    infoEvento3.open(map, locacionEvento3Marker);
  });
